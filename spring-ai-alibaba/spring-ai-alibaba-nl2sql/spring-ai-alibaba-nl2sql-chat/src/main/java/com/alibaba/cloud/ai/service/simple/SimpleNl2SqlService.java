...
public class SimpleNl2SqlService extends BaseNl2SqlService {
	...
	public SimpleNl2SqlService(@Qualifier("simpleVectorStoreService") BaseVectorStoreService vectorStoreService,
			...
			@Qualifier("mysqlAccessor") Accessor accessor, DbConfig dbConfig, HybridSqlConverter hybridSqlConverter) {

		super(vectorStoreService, schemaService, aiService, accessor, dbConfig, hybridSqlConverter);
	}
