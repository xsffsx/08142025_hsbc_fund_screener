...
public class AnalyticNl2SqlService extends BaseNl2SqlService {
	...
	public AnalyticNl2SqlService(@Qualifier("analyticVectorStoreService") BaseVectorStoreService vectorStoreService,
			...
			@Qualifier("mysqlAccessor") Accessor dbAccessor, DbConfig dbConfig, HybridSqlConverter hybridSqlConverter) {
		super(vectorStoreService, schemaService, aiService, dbAccessor, dbConfig, hybridSqlConverter);
	}
