...
public class BaseNl2SqlService {
	...
	protected final HybridSqlConverter hybridSqlConverter;

	public BaseNl2SqlService(BaseVectorStoreService vectorStoreService, BaseSchemaService schemaService,
			LlmService aiService, Accessor dbAccessor, DbConfig dbConfig, HybridSqlConverter hybridSqlConverter) {
		logger.info(
				"Initializing BaseNl2SqlService with components: vectorStoreService={}, schemaService={}, aiService={}, dbAccessor={}, dbConfig={}, hybridSqlConverter={}",
				...
				hybridSqlConverter.getClass().getSimpleName());
		this.vectorStoreService = vectorStoreService;
		this.schemaService = schemaService;
		this.aiService = aiService;
		this.dbAccessor = dbAccessor;
		this.dbConfig = dbConfig;
		this.hybridSqlConverter = hybridSqlConverter;
	...
	public String generateSql(List<String> evidenceList, String query, SchemaDTO schemaDTO, String sql,
		...
		logger.info("Generated SQL before conversion: {}", result);

		// 使用混合SQL转换器进行语法转换
		String convertedSql = hybridSqlConverter.convertSql(result, dbConfig.getDialectType());
		logger.info("Final SQL after conversion: {}", convertedSql);
