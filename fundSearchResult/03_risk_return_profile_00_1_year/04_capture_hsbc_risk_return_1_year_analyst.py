...
async def main_fund_screener(headless: bool = True):
    """主函数：捕获基金 Risk return profile -> 1 year 页面的 API"""

    print("="*60)
    print(f"🚀 基金 Risk Return Profile -> 1 year API 捕获模式")
    ...
    print(f"\n🎯 基金 Risk Return Profile -> 1 year API 捕获完成！")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'screener':
        ...
        # 运行基金 Risk Return Profile -> 1 year 捕获
