...
| 2 | **1 month** | 1.24% | `1.24` | `performance.annualizedReturns.return1Mth` | `return1mth` | `v_ut_prod_instm` | `rtrn_1mo_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 3 | **3 month** | 3.25% | `3.25` | `performance.annualizedReturns.return3Mth` | `return3mth` | `v_ut_prod_instm` | `rtrn_3mo_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 4 | **6 month** | 0.90% | `0.90` | `performance.annualizedReturns.return6Mth` | `return6mth` | `v_ut_prod_instm` | `rtrn_6mo_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 5 | **1 year** | 1.85% | `1.85` | `performance.annualizedReturns.return1Yr` | `return1yr` | `v_ut_prod_instm` | `rtrn_1yr_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 6 | **3 year** | 1.82% | `1.82` | `performance.annualizedReturns.return3Yr` | `return3yr` | `v_ut_prod_instm` | `rtrn_3yr_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 7 | **5 year** | -7.36% | `-7.36` | `performance.annualizedReturns.return5Yr` | `return5yr` | `v_ut_prod_instm` | `rtrn_5yr_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 8 | **10 year** | -1.36% | `-1.36` | `performance.annualizedReturns.return10Yr` | `return10yr` | `v_ut_prod_instm` | `rtrn_10yr_amt` | 百分比格式化 | ✅ 数据库验证通过 |
| 9 | **Since inception** | -1.12% | `-1.12` | `performance.annualizedReturns.returnSinceInception` | `returnSinceInception` | `v_ut_prod_instm` | `rtrn_since_incpt_amt` | 百分比格式化 | ✅ 数据库验证通过 |

### 数据库实际验证数据样本
基于实际查询 `schema_price.v_ut_prod_instm` 的结果：

| 基金名称 | 1月 | 3月 | 6月 | 1年 | 3年 | 5年 | 10年 | 成立以来 |
|---------|-----|-----|-----|-----|-----|-----|------|----------|
| BlackRock World Gold Fund (Class A2) | 5.23000 | 12.45000 | 18.67000 | 22.41986 | 15.89000 | 12.34000 | 8.76000 | 7.45000 |
| Value Partners Greater China High Yield Income (A-AUDH-MDIST-Cash) | 5.23000 | 12.45000 | 18.67000 | 22.41986 | 15.89000 | 12.34000 | 8.76000 | 7.45000 |
