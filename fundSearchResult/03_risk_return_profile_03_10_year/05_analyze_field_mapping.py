...
def map_fields_to_api(frontend_fields: Dict[str, str], sample_product: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
    ...
    field_mapping["Standard deviation"] = {
        ...
        "api_path": "risk[year=10].yearRisk.stdDev",
    ...
    field_mapping["Sharpe ratio"] = {
        ...
        "api_path": "risk[year=10].yearRisk.sharpeRatio",
    ...
    field_mapping["Alpha"] = {
        ...
        "api_path": "risk[year=10].yearRisk.alpha",
        "api_value": alpha,
        "data_type": "number",
        "example": "0.93"
    }
    ...
    field_mapping["Beta"] = {
        ...
        "api_path": "risk[year=10].yearRisk.beta",
        "api_value": beta,
        "data_type": "number",
        "example": "0.93"
    }
...
**请求方法**: POST"""
    ...
    report = f"""# HSBC Fund Screener - Risk return profile -> 10 year 字段映射分析报告
