...
public class AsetVoltlClassCharLoaderTest {
    ...
    @Mock
    private AsetVoltlClassCharLoader asetVoltlClassCharLoader;

    @Before
    public void setUp() throws Exception {
        when(mockMongodb.getCollection(CollectionName.aset_voltl_class_char)).thenReturn(colAsetVoltlClass);
        asetVoltlClassCharLoader = new AsetVoltlClassCharLoader(mockNamedParameterJdbcTemplate,mockMongodb);
        ReflectionTestUtils.setField(asetVoltlClassCharLoader, "sequenceService", sequenceService);
