...
@Slf4j
public class ProdTypeFinDocSynchronizer implements DataSynchronizer {
    protected MongoCollection collection;
    protected NamedParameterJdbcTemplate namedParameterJdbcTemplate;
    protected String table;

    public ProdTypeFinDocSynchronizer(String table, NamedParameterJdbcTemplate namedParameterJdbcTemplate, MongoDatabase mongodb) {
        this.table = table;
        this.namedParameterJdbcTemplate = namedParameterJdbcTemplate;
        this.collection = mongodb.getCollection(CollectionName.prod_type_fin_doc);
    }
    ...
    public void sync(Set<Map<String, Object>> keySet) {
        log.info("Updating {} Financial Document(s) ...", keySet.size());
        keySet.forEach(keys -> {
    ...
    public void delete(Set<String> rowidSet) {
        ...
        log.info("{} {} item has been deleted", result.getDeletedCount(), CollectionName.prod_type_fin_doc);
    }
}