...
@DocumentObject("listProd")
@Data
public class ProductListSegment {

	@DocumentField("listProdType")
	private String prodListTypeCde;

	@DocumentField("listProdCde")
	private String prodListCde;
}
