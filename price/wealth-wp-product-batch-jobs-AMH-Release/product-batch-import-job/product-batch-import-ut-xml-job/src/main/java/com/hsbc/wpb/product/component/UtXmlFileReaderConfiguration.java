...
@Configuration
public class UtXmlFileReaderConfiguration {
    ...
    @Bean
    @StepScope
    public ItemStreamReader<ProductStreamItem> utXmlFileReader(ProductService productService,
        ...
        marshaller.setClassesToBeBound(UnitTrustInstrument.class);
        StaxEventItemReader<UnitTrustInstrument> staxEventItemReader = new StaxEventItemReader<>();
        staxEventItemReader.setFragmentRootElementName("utTrstInstm");
        ...
        return new ProductStreamItemByKeyItemReaderBuilder<UnitTrustInstrument>()
                .name("utXmlFileReader")
    ...
    private final Function<UnitTrustInstrument, ProductKey> toProductKey = unitTrustInstrument -> {
        ProductKeySegment prodKeySeg = unitTrustInstrument.getProdKeySeg();
