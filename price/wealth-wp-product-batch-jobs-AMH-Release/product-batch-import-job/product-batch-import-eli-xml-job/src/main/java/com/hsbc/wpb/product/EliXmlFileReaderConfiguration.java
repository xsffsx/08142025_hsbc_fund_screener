...
import com.dummy.wpb.product.model.xml.EliInstrument;
...
@Configuration
public class EliXmlFileReaderConfiguration {
    ...
    @Bean
    @StepScope
    public ItemStreamReader<ProductStreamItem> eliXmlFileReader(ProductService productService,
        ...
        marshaller.setClassesToBeBound(EliInstrument.class);
        StaxEventItemReader<EliInstrument> staxEventItemReader = new StaxEventItemReader<>();
        staxEventItemReader.setFragmentRootElementName("eli");
        ...
        return new ProductStreamItemByKeyItemReaderBuilder<EliInstrument>()
                .name("eliXmlFileReader")
    ...
    private final Function<EliInstrument, ProductKey> toProductKey = eliInstrument -> {
        ProductKeySegment prodKeySeg = eliInstrument.getProdKeySeg();
