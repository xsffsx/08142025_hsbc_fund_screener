...
import com.dummy.wpb.product.model.xml.ProductPerformance;
...
@Configuration
public class UtPerfmXmlFileReaderConfiguration {
    ...
    @Bean
    @StepScope
    public ItemStreamReader<ProductStreamItem> utPerfmXmlFileReader(ProductService productService,
        ...
        marshaller.setClassesToBeBound(ProductPerformance.class);
        StaxEventItemReader<ProductPerformance> staxEventItemReader = new StaxEventItemReader<>();
        staxEventItemReader.setFragmentRootElementName("prodPerf");
        ...
        return new ProductStreamItemByKeyItemReaderBuilder<ProductPerformance>()
    ...
    private final Function<ProductPerformance, ProductKey> toProductKey = performance -> {
        ProductKeySegment prodKeySeg = performance.getProdKeySeg();
