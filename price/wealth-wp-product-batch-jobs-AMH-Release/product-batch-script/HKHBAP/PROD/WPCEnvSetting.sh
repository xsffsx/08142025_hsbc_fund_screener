...
BATCH_URL="https://batch-controller.wealth-platform-amh.ape1.prod.aws.cloud.dummy/api/product-dp-file-egress/export"
BATCH_INGRESS_URL="https://batch-controller.wealth-platform-amh.ape1.prod.aws.cloud.dummy/api/product-dp-file-ingress"
BATCH_INTERNAL_JOBS_URL="https://batch-controller.wealth-platform-amh.ape1.prod.aws.cloud.dummy/api/product-dp-file-ingress/jobs"

#############################################################
###          Batch Server Path INFO                       ###
#############################################################
BATCH_APP_PATH="/appvol/product-spring-batch/bin/HKHBAP"
...
S3_BUCKETNAME="s3://wealth-prod-wpamhdatatogcstransfer/smart_local/"
...
FINDOC_CP_S3_PATH=wealth-prod-appcontent/wealth-platform-amh/v1/wpc/data/hk/invest
FINDOC_CP_S3_SCRIPT="--content-type application/pdf --region eu-west-1 --sse --endpoint-url https://bucket.vpce-062409bfb173af31a-rrvr9dv4.s3.eu-west-1.vpce.amazonaws.com"
...
GSOPS_IDW_HK_FTP_USER="HKGSFTSA"
GSOPS_IDW_HK_FTP_HOST="prod.gsops.hk.dummy"
GSOPS_IDW_HK_FTP_PORT="22"
GSOPS_IDW_HK_FTP_PATH="/home/ris_home_hkg/input/ris-hfi-gsops"
GSOPS_IDW_FTP_SPEC_PROC_IND="Y"

GSOPSU_FTP_COUNT=1
GSOPSU_FTP_USER_1="HKGSFTSA"
GSOPSU_FTP_HOST_1="prod.gsops.hk.dummy"
GSOPSU_FTP_PORT_1="22"
GSOPSU_FTP_PATH_1="/home/ris_home_hkg/input/ris-wpc-gsops"

GSOPSE_FTP_COUNT=1
GSOPSE_FTP_USER_1="HKGSFTSA"
GSOPSE_FTP_HOST_1="prod.gsops.hk.dummy"
GSOPSE_FTP_PORT_1="22"
GSOPSE_FTP_PATH_1="/home/ris_home_hkg/input/ris-wpc-gsops"

GSOPSB_FTP_COUNT=1
GSOPSB_FTP_USER_1="HKGSFTSA"
GSOPSB_FTP_HOST_1="prod.gsops.hk.dummy"
GSOPSB_FTP_PORT_1="22"
GSOPSB_FTP_PATH_1="/home/ris_home_hkg/input/ris-wpc-gsops"

GSOPSD_FTP_COUNT=1
GSOPSD_FTP_USER_1="HKGSFTSA"
GSOPSD_FTP_HOST_1="prod.gsops.hk.dummy"
GSOPSD_FTP_PORT_1="22"
GSOPSD_FTP_PATH_1="/home/ris_home_hkg/input/ris-wpc-gsops"
...
###          Treemap FTP Profile                          ###
#############################################################
RMP_FTP_USER="@ftp.user.rmp@"
RMP_FTP_HOST="@ftp.host.rmp@"
RMP_FTP_PORT=@ftp.port.rmp@
RMP_FTP_PATH="@ftp.remote.path.rmp@"

RMP_AE_FTP_USER="@ftp.user.rmp.ae@"
RMP_AE_FTP_HOST="@ftp.host.rmp.ae@"
RMP_AE_FTP_PORT=@ftp.port.rmp.ae@
RMP_AE_FTP_PATH="@ftp.remote.path.rmp.ae@"

RMP_CN_FTP_USER="@ftp.user.rmp.cn@"
RMP_CN_FTP_HOST="@ftp.host.rmp.cn@"
RMP_CN_FTP_PORT=@ftp.port.rmp.cn@
RMP_CN_FTP_PATH="@ftp.remote.path.rmp.cn@"

RMP_ID_FTP_USER="@ftp.user.rmp.id@"
RMP_ID_FTP_HOST="@ftp.host.rmp.id@"
RMP_ID_FTP_PORT=@ftp.port.rmp.id@
RMP_ID_FTP_PATH="@ftp.remote.path.rmp.id@"


RMP_MY_FTP_USER="@ftp.user.rmp.my@"
RMP_MY_FTP_HOST="@ftp.host.rmp.my@"
RMP_MY_FTP_PORT=@ftp.port.rmp.my@
RMP_MY_FTP_PATH="@ftp.remote.path.rmp.my@"

RMP_SG_FTP_USER="@ftp.user.rmp.sg@"
RMP_SG_FTP_HOST="@ftp.host.rmp.sg@"
RMP_SG_FTP_PORT=@ftp.port.rmp.sg@
RMP_SG_FTP_PATH="@ftp.remote.path.rmp.sg@"

RMP_IN_FTP_USER="@ftp.user.rmp.in@"
RMP_IN_FTP_HOST="@ftp.host.rmp.in@"
RMP_IN_FTP_PORT=@ftp.port.rmp.in@
RMP_IN_FTP_PATH="@ftp.remote.path.rmp.in@"
...
ELI_FINDOC_FTP_HOST="sftp-wrs.gss4.hk.dummy"
...
SID_FINDOC_FTP_HOST="sftp-wrs.gss4.hk.dummy"
...
FS_FINDOC_FTP_HOST="sftp-wrs.gss4.hk.dummy"
FS_FINDOC_FTP_PORT="22"

ARC_FS_FINDOC_FTP_USER="arc01adm"
ARC_FS_FINDOC_FTP_HOST="hkl20064481.hk.dummy"
ARC_FS_FINDOC_FTP_PORT="22"
ARC_FS_FTP_REMOTE_PATH="/dummy/arc/app/ftp/outgoing"

ENS_USER="hbap-sftp-ens-hfi"
ENS_HOST="ens1-sftp.hk.dummy"
ENS_PORT="22"
...
###          WIM SFTP Profile                         ###
#############################################################
WIM_HK_FTP_USER="wsdftp08"
WIM_HK_FTP_HOST="hp69-etl-systems.hk.dummy"
WIM_HK_FTP_PORT="22"
WIM_HK_FTP_PATH="/ds/hp69/data/dpr_hp6901/dpr_bisgcp_prod/landing/wpc"
