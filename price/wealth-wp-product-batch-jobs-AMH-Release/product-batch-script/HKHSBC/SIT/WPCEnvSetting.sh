...
BATCH_URL="https://batch-controller.wealth-platform-amh.dev.aws.cloud.dummy/api/product-dp-file-egress/export"
BATCH_INGRESS_URL="https://batch-controller.wealth-platform-amh.dev.aws.cloud.dummy/api/product-dp-file-ingress"
BATCH_INTERNAL_JOBS_URL="https://batch-controller.wealth-platform-amh.dev.aws.cloud.dummy/api/product-dp-file-ingress/jobs"
