...
GFIX_LISTENER_SERVICE_PERIOD="43200"
GFIX_LISTENER_MONITOR_INTERVAL="120"
GFIX_MASTER_HOST="hkgv3ls0787"
BATCH_URL="https://batch-controller.wealth-platform-sgh.prod.aws.cloud.dummy/api/product-dp-file-egress/export"
BATCH_INGRESS_URL="https://batch-controller.wealth-platform-sgh.prod.aws.cloud.dummy/api/product-dp-file-ingress"
BATCH_INTERNAL_JOBS_URL="https://batch-controller.wealth-platform-sgh.prod.aws.cloud.dummy/api/product-dp-file-ingress/jobs"
...
RMP_FTP_HOST="sftp-prod-asp-rmp.hk.dummy"
RMP_FTP_PORT=22
...
###          WIM SFTP Profile                         ###
#############################################################
#WIM_HK_FTP_USER="cstftp08"
#WIM_HK_FTP_HOST="hp69-etl-systems.hk.dummy"
#WIM_HK_FTP_PORT="22"
#WIM_HK_FTP_PATH="/ds/hp69/data/dpr_hp6902/dpr_biscst_prd/landing/wpc_mongo"
