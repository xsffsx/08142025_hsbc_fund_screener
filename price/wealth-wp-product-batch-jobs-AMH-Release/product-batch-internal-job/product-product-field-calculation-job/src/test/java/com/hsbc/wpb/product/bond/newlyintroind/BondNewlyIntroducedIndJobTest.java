...
@SpringBootTest(classes = FieldCalculationJobApplication.class,
        args = {"ctryRecCde=HK", "grpMembrRecCde=HBAP", "calculatedField=bondNewlyIntroducedInd"})
@RunWith(SpringJUnit4ClassRunner.class)
public class BondNewlyIntroducedIndJobTest {
    ...
    @Autowired
    private BondNewlyIntroIndUpdateTasklet bondNewlyIntroIndUpdateTasklet;
    @Autowired
    private BondNewlyIntroIndCleanOldSortTasklet bondNewlyIntroIndCleanOldSortTasklet;
    ...
    public JobExecution getJobExecution() {
        return MetaDataInstanceFactory.createJobExecution("bondNewlyIntroducedIndJob", 1L, 1L,jobParameters);
    }
    ...
    @Test
    public void testBondNewlyIntroducedIndCleanOldSortJob() throws Exception {
        ...
        Assertions.assertDoesNotThrow(() -> bondNewlyIntroIndCleanOldSortTasklet.execute(stepContribution,chunkContext));
    }

    @Test
    public void testBondNewlyIntroducedIndUpdateJob() throws Exception {
        ...
        StepContribution stepContribution = new StepContribution(getStepExecution());
        ChunkContext chunkContext = new ChunkContext(new StepContext(getStepExecution()));
        Assertions.assertDoesNotThrow(() -> bondNewlyIntroIndUpdateTasklet.execute(stepContribution,chunkContext));
    }
}
