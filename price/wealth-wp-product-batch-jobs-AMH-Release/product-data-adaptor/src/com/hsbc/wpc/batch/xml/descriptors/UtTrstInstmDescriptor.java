 ...
 * Schema.
 * $Id: src/com/dummy/wpc/batch/xml/descriptors/UtTrstInstmDescriptor.java 1.3 2011/12/06 19:08:21CST Navagate Developer 10 (WMDHKG0028) Development  $
 */
...
/**
 * Class UtTrstInstmDescriptor.
 * 
 * @version $Revision: 1.3 $ $Date: 2011/12/06 19:08:21CST $
 */
public class UtTrstInstmDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public UtTrstInstmDescriptor() {
        super();
        _xmlName = "utTrstInstm";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                UtTrstInstm target = (UtTrstInstm) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _utTrstInstmSeg
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.dummy.wpc.batch.xml.UtTrstInstmSeg.class, "_utTrstInstmSeg", "utTrstInstmSeg", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                UtTrstInstm target = (UtTrstInstm) object;
                return target.getUtTrstInstmSeg();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    UtTrstInstm target = (UtTrstInstm) object;
                    target.setUtTrstInstmSeg( (com.dummy.wpc.batch.xml.UtTrstInstmSeg) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.dummy.wpc.batch.xml.UtTrstInstmSeg();
            }
        };
        desc.setSchemaType("com.dummy.wpc.batch.xml.UtTrstInstmSeg");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        //-- validation code for: _utTrstInstmSeg
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.dummy.wpc.batch.xml.UtTrstInstm.class;
    }
