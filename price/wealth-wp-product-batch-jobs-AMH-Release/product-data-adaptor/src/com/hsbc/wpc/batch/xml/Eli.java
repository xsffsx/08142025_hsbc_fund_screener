 ...
 * Schema.
 * $Id: src/com/dummy/wpc/batch/xml/Eli.java 1.3 2011/12/06 19:07:58CST Navagate Developer 10 (WMDHKG0028) Development  $
 */
 ...
 */
public class Eli implements java.io.Serializable {
     ...
     * Field _eliSeg.
     */
    private com.dummy.wpc.batch.xml.EliSeg _eliSeg;
    ...
    /**
     * Returns the value of field 'eliSeg'.
     * 
     * @return the value of field 'EliSeg'.
     */
    public com.dummy.wpc.batch.xml.EliSeg getEliSeg(
    ) {
        return this._eliSeg;
    }
    ...
    /**
     * Sets the value of field 'eliSeg'.
     * 
     * @param eliSeg the value of field 'eliSeg'.
     */
    public void setEliSeg(
            final com.dummy.wpc.batch.xml.EliSeg eliSeg) {
        this._eliSeg = eliSeg;
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.dummy.wpc.batch.xml.Eli
     */
    public static com.dummy.wpc.batch.xml.Eli unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.dummy.wpc.batch.xml.Eli) Unmarshaller.unmarshal(com.dummy.wpc.batch.xml.Eli.class, reader);
    }
