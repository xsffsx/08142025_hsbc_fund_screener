 ...
 * Schema.
 * $Id: src/com/dummy/wpc/batch/xml/StockInstm.java 1.3 2011/12/06 19:08:23CST Navagate Developer 10 (WMDHKG0028) Development  $
 */
 ...
 */
public class StockInstm implements java.io.Serializable {
    ...
    /**
     * Field _stockInstmSeg.
     */
    private com.dummy.wpc.batch.xml.StockInstmSeg _stockInstmSeg;
    ...
    /**
     * Returns the value of field 'stockInstmSeg'.
     * 
     * @return the value of field 'StockInstmSeg'.
     */
    public com.dummy.wpc.batch.xml.StockInstmSeg getStockInstmSeg(
    ) {
        return this._stockInstmSeg;
    }
    ...
    /**
     * Sets the value of field 'stockInstmSeg'.
     * 
     * @param stockInstmSeg the value of field 'stockInstmSeg'.
     */
    public void setStockInstmSeg(
            final com.dummy.wpc.batch.xml.StockInstmSeg stockInstmSeg) {
        this._stockInstmSeg = stockInstmSeg;
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.dummy.wpc.batch.xml.StockInstm
     */
    public static com.dummy.wpc.batch.xml.StockInstm unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.dummy.wpc.batch.xml.StockInstm) Unmarshaller.unmarshal(com.dummy.wpc.batch.xml.StockInstm.class, reader);
    }
