 ...
 * Schema.
 * $Id: src/com/dummy/wpc/batch/xml/DebtInstm.java 1.3 2011/12/06 19:08:22CST Navagate Developer 10 (WMDHKG0028) Development  $
 */
 ...
 * Class DebtInstm.
 * 
 * @version $Revision: 1.3 $ $Date: 2011/12/06 19:08:22CST $
 */
public class DebtInstm implements java.io.Serializable {
     ...
     * Field _debtInstmSeg.
     */
    private com.dummy.wpc.batch.xml.DebtInstmSeg _debtInstmSeg;
    ...
    /**
     * Returns the value of field 'debtInstmSeg'.
     * 
     * @return the value of field 'DebtInstmSeg'.
     */
    public com.dummy.wpc.batch.xml.DebtInstmSeg getDebtInstmSeg(
    ) {
        return this._debtInstmSeg;
    }
    ...
    /**
     * Sets the value of field 'debtInstmSeg'.
     * 
     * @param debtInstmSeg the value of field 'debtInstmSeg'.
     */
    public void setDebtInstmSeg(
            final com.dummy.wpc.batch.xml.DebtInstmSeg debtInstmSeg) {
        this._debtInstmSeg = debtInstmSeg;
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.dummy.wpc.batch.xml.DebtInstm
     */
    public static com.dummy.wpc.batch.xml.DebtInstm unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.dummy.wpc.batch.xml.DebtInstm) Unmarshaller.unmarshal(com.dummy.wpc.batch.xml.DebtInstm.class, reader);
    }
