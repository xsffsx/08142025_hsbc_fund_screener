 ...
 * Schema.
 * $Id: src/com/dummy/wpc/batch/xml/UtTrstInstm.java 1.3 2011/12/06 19:08:25CST Navagate Developer 10 (WMDHKG0028) Development  $
 */
 ...
 */
public class UtTrstInstm implements java.io.Serializable {
    ...
    /**
     * Field _utTrstInstmSeg.
     */
    private com.dummy.wpc.batch.xml.UtTrstInstmSeg _utTrstInstmSeg;
    ...
    /**
     * Returns the value of field 'utTrstInstmSeg'.
     * 
     * @return the value of field 'UtTrstInstmSeg'.
     */
    public com.dummy.wpc.batch.xml.UtTrstInstmSeg getUtTrstInstmSeg(
    ) {
        return this._utTrstInstmSeg;
    }
    ...
    /**
     * Sets the value of field 'utTrstInstmSeg'.
     * 
     * @param utTrstInstmSeg the value of field 'utTrstInstmSeg'.
     */
    public void setUtTrstInstmSeg(
            final com.dummy.wpc.batch.xml.UtTrstInstmSeg utTrstInstmSeg) {
        this._utTrstInstmSeg = utTrstInstmSeg;
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.dummy.wpc.batch.xml.UtTrstInstm
     */
    public static com.dummy.wpc.batch.xml.UtTrstInstm unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.dummy.wpc.batch.xml.UtTrstInstm) Unmarshaller.unmarshal(com.dummy.wpc.batch.xml.UtTrstInstm.class, reader);
    }
