...
public class GenExcelSpoms  implements GenExcel{

    private static final Logger LOGGER = Logger.getLogger(GenExcelSpoms.class);
    ...
    public HSSFWorkbook generate(List input,String specialTitleConfigFileName) throws ParseException, WPCBaseException {
        ...
        try {
            ...
            return outWb;
             ...
             throw new ParseException(this.getClass(), "generate", pe.getMessage());
         }catch (Exception e) {
             LOGGER.error(e.getMessage());
            throw new WPCBaseException(this.getClass(), "generate", e.getMessage());                    
        }finally {
            try {
                if (reader != null) {
                    reader.close();
