...
public class ExcelMultiFileReaderMandatoryCheck extends CommonMandatoryCheck {
	...
	public boolean check() {
		...
		String fileCountStr = configMap.get(Constants.READER_COUNT);
		int fileCount = 0;
		try{
		...
		if(StringUtils.isEmpty(fileCountStr) || fileCount <= 0){
