...
public class TmdsidMapper extends AbstractFieldSetMapper{
	private String accept = "1";
	private String aborted = "2";
	private String cancelled = "3";
	private String completed = "4";
	private String closed = "5";
...
//	    MultiWriterObj multiObject = new MultiWriterObj();
		...
		prodInfoSeg.setProdStatCde(exchangeProdStatCde(fieldSet.readString("STAT_CDE")));
...
//        multiObject.addObj(prodPrc);
	...
	private String exchangeProdStatCde(String prodStat){
		String prodStatCde = null;
		if(StringUtils.isNotBlank(prodStat) && !accept.equals(prodStat)){
			if(completed.equals(prodStat)){
				prodStatCde = "E";
			} else if (aborted.equals(prodStat) || cancelled.equals(prodStat)){
				prodStatCde = "T";
			} else if (closed.equals(prodStat)){
				prodStatCde = "C";
			}
		} else {
			prodStatCde = "A";
