 ...
 * @apiHeader (CommonPostHeaderGroup) {String} 	X-hhhh-Staff-Id  The Staff uniquely identifies.
 * @apiHeader (CommonPostHeaderGroup) {String} 	X-hhhh-Customer-Id  The customer unique identifies.
