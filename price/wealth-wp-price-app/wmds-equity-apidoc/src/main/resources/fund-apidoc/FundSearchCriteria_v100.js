/**
 * @api {get} /wealth/api/v1/market-data/fund/search/reference-data FundSearchCriteria
 * @apiName FundSearchCriteria
 * @apiGroup Search
 * @apiVersion 1.0.0
 * 
 ...
 * @apiSuccess {String} listCriterias.items.parent The parent key.
 * 
