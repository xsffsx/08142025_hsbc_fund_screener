 ...
 * 
 * @apiHeader (CommonHeaderGroup) {String} X-hhhh-App-Code The application code which identify the application of request.</br> Sample value: "WD" 
 * @apiHeader (CommonHeaderGroup) {String{2}} X-hhhh-Chnl-CountryCode The country code of this entity request.</br> Sample value: "HK"
 * @apiHeader (CommonHeaderGroup) {String{4}} X-hhhh-Chnl-Group-Member The group member code of this entity request.</br> Sample value: "HBAP"
 ...
 * @apiHeader (CommonHeaderGroup) {String="en","zh_HK","zh_CN"} X-hhhh-Locale The locale code of the request. Possible values - en(English), zh_HK (Traditional Chinese), zh_CN(Simplified Chinese).
 * @apiHeader (CommonHeaderGroup) {String} X-hhhh-Saml3 The SAML end to end trust token.
 * @apiHeader (CommonHeaderGroup) {String} X-hhhh-Function-Id Request function ID per FE module id.
