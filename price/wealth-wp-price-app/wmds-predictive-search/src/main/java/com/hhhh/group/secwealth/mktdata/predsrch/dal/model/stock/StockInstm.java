...
@XmlType(name = "", propOrder = {"prodKeySeg", "prodAltNumSeg", "prodInfoSeg", "stockInstmSeg", "recDtTmSeg"})
...
public class StockInstm {
    ...
    @XmlElement(required = true)
    protected StockInstmSeg stockInstmSeg;
    ...
    /**
     * Gets the value of the stockInstmSeg property.
     * 
     * @return possible object is {@link StockInstmSeg }
     * 
     */
    ...
    /**
     * Sets the value of the stockInstmSeg property.
     * 
     * @param value
     *            allowed object is {@link StockInstmSeg }
     * 
     */
    public void setStockInstmSeg(final StockInstmSeg value) {
        this.stockInstmSeg = value;
    }
