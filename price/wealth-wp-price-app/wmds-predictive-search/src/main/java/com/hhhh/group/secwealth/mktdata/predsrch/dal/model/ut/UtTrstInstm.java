...
@XmlType(name = "", propOrder = {"prodKeySeg", "prodAltNumSeg", "prodInfoSeg", "utTrstInstmSeg", "recDtTmSeg"})
...
public class UtTrstInstm {
    ...
    @XmlElement(required = true)
    protected UtTrstInstmSeg utTrstInstmSeg;
    ...
    /**
     * Gets the value of the utTrstInstmSeg property.
     * 
     * @return possible object is {@link UtTrstInstmSeg }
     * 
     */
    ...
    /**
     * Sets the value of the utTrstInstmSeg property.
     * 
     * @param value
     *            allowed object is {@link UtTrstInstmSeg }
     * 
     */
    public void setUtTrstInstmSeg(final UtTrstInstmSeg value) {
        this.utTrstInstmSeg = value;
    }
