...
@XmlType(name = "", propOrder = {"prodKeySeg", "prodAltNumSeg", "prodInfoSeg", "sidSeg", "recDtTmSeg"})
@XmlRootElement(name = "sid")
@Searchable
public class Sid {
     ...
     * 
     */
    public void setSidSeg(final SidSeg value) {
        this.sidSeg = value;
    }
