...
public final class CommonConstants {
    ...
    public static final String JSONARRAY_STRING_NULL = "[\"\\\"null\\\"\"]";

    public static final String JSONARRAY_NULL = "[null]";
    ...
    public final static String PATTERN_SPECIAL_CHARACTERS = "[^?*]+";
    ...
    public final static String OUTBOUND_MSG_PREFIX = "Outbound message: ";

    /** The Constant INBOUND_MSG_PREFIX. */
    public final static String INBOUND_MSG_PREFIX = "Inbound message: ";

    /** The Constant QUERY_DATA_FROM_DATABASE. */
    public final static String QUERY_DATA_FROM_DATABASE = "Query data from Database: ";

    /** The Constant FIRST_LEVEL_SEPARATOR. */
    public final static String FIRST_LEVEL_SEPARATOR = ",";

    /** The Constant SECOND_LEVEL_SEPARATOR. */
    public final static String SECOND_LEVEL_SEPARATOR = "\\|";

    /** The Constant THIRD_LEVEL_SEPARATOR. */
    public final static String THIRD_LEVEL_SEPARATOR = ":";

    /** The Constant ORIGINAL_FIELD_SUFFIX. */
    public final static String ORIGINAL_FIELD_SUFFIX = "_ORIGINAL";

    public final static String TOKEN_FIELD_SUFFIX = "_token";
    ...
    public final static String hhhh_FUND_FAMILY_CODE = "0C00001UXA";

    public final static int hhhh_FUND_INITIAL_RRSP = 500;

    public final static int hhhh_FUND_ADDITIONAL_RRSP = 100;

    public final static int NON_hhhh_FUND_INITIAL_RRSP = 1000;

    public final static int NON_hhhh_FUND_ADDITIONAL_RRSP = 1000;

    /** The Constant SPECIAL_STRING_FILTER_SEPARATOR. */
    public final static char SPECIAL_STRING_FILTER_SEPARATOR = '\\';
    // Request HEADER
    public final static String REQUEST_HEADER_COUNTRYCODE = "x-hhhh-chnl-countrycode";
    public final static String REQUEST_HEADER_GROUPMEMBER = "x-hhhh-chnl-group-member";
    public final static String REQUEST_HEADER_CHANNELID = "x-hhhh-channel-id";
    public final static String REQUEST_HEADER_LOCALE = "x-hhhh-locale";
    public final static String REQUEST_HEADER_APPCODE = "x-hhhh-app-code";
    public final static String REQUEST_HEADER_LINEOFBUSINESS = "x-hhhh-line-of-business";
    // e2eTrust Request HEADER
    public final static String E2ETRUST_HEADER_WEALTHSAML = "X-hhhh-Wealth-Saml";
    public final static String E2ETRUST_HEADER_SAML = "X-hhhh-Saml";

    public final static String USERTYPE = "userType";
    public final static String EID = "eid";

    public final static String DEFAULT_SYSTEMID = "MDSFE";

    public static final String ENTITY_CN = "CN_hhhh";
    public static final String ENTITY_UK = "GB_HBEU";

    public final static String REQUEST_PARAM_DELAY = "delay";
    public final static String REQUEST_PARAM_ENTITYTIMEZONE = "entityTimezone";
    public final static String REQUEST_PARAM_USERTYPE = "userType";
    public final static String REQUEST_PARAM_USERID = "userId";
    public final static String REQUEST_PARAM_TRADEDAY = "tradeDay";
    public final static String REQUEST_PARAM_TRADEHOURS = "tradeHours";
    public final static String REQUEST_PARAM_MARKET = "market";
    public final static String REQUEST_PARAM_SKIPAGREEMENTCHECK = "skipAgreementCheck";
    public final static String REQUEST_PARAM_FREEQUOTE = "freeQuote";
    public final static String REQUEST_PARAM_REQUESTTYPE = "requestType";
    public final static String REQUEST_PARAM_ADJUSTEDCUSSEGMENT = "adjustedCusSegment";
    public final static String REQUEST_PARAM_SIDE = "side";
    public final static String REQUEST_PARAM_QUANTITY = "quantity";
    public final static String REQUEST_PARAM_BIDASKQUOTE = "bidAskQuote";
