...
@XmlType(name = "", propOrder = {"prodKeySeg", "prodAltNumSeg", "prodInfoSeg", "debtInstmSeg", "recDtTmSeg"})
...
public class DebtInstm {
    ...
    @XmlElement(required = true)
    protected DebtInstmSeg debtInstmSeg;
     ...
     * 
     */
    public DebtInstmSeg getDebtInstmSeg() {
        return this.debtInstmSeg;
    }
     ...
     * 
     */
    public void setDebtInstmSeg(final DebtInstmSeg value) {
        this.debtInstmSeg = value;
    }
