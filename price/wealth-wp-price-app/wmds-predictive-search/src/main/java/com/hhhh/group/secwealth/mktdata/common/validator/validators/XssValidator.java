...
public class XssValidator {
    ...
    private XssValidator() {
        ...
        try {
            ...
            LogUtil.error(XssValidator.class, "XssValidator error: dictionary is " + String.join(",", this.dictionary), e);
            ...
            if (br != null) {
                try {
                    ...
                    LogUtil.error(XssValidator.class, "close BufferedReader error", e);
                }
            }
