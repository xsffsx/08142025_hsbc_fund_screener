...
@XmlType(name = "", propOrder = {"prodKeySeg", "prodAltNumSeg", "prodInfoSeg", "eliSeg", "recDtTmSeg"})
...
public class Eli {
     ...
     * 
     */
    public void setEliSeg(final EliSeg value) {
        this.eliSeg = value;
    }
