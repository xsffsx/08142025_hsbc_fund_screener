...
public class LabciNewsDetail4CmbService extends LabciNewsDetailService {

    private static final Logger logger = LoggerFactory.getLogger(LabciNewsDetail4CmbService.class);
    ...
    protected Object execute(Object obj) throws Exception {
        super.setLabciAmhUSProperties(this.labciProtalProperties);
