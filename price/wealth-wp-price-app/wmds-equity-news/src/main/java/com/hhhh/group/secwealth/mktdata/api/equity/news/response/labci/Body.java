...
@XmlType(name = "", propOrder = {"stockslist", "totalrecordno", "newslist", "newsid", "newstopic", "newscontent",
    "lastupdateddate", "lastupdatedtime", "timezone", "newscompany","newslang"})
...
public class Body {
    ...
    @XmlElement(required = true)
    protected List<NewsList> newslist;
    ...
    public void setNewslist(final List<NewsList> newslist) {
