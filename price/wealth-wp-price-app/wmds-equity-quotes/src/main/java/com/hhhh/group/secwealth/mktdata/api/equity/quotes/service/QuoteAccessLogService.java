 ...
 * </p>
 */
@Service("quotesQuoteAccessLogService")
public class QuoteAccessLogService {
	...
	public void saveQuoteAccessLog(final List<QuoteAccessLogForQuotes> quoteList) {
		try {
			...
			QuoteAccessLogService.logger.error("batch insert data failure.", e);
