...
public class QuotesUSCachingServer4RbpServiceTest {

    @InjectMocks
    private QuotesUSCachingServer4RbpService quotesUSCachingServer4RbpService;
...
//        when(pastPerformanceService.getPastPerformance(any(String.class),any(String.class),any(String.class))).thenReturn(pastPerformance);
    ...
    public void testConvertRequest() throws Exception {
        Object obj = quotesUSCachingServer4RbpService.convertRequest(secQuotesRequest, commonRequestHeader);
        assertNotNull(obj);
    }
    ...
    public void testExecute() throws Exception {
        Object quoteServiceRequest = this.quotesUSCachingServer4RbpService.convertRequest(secQuotesRequest, commonRequestHeader);
        Object serviceResponseMapper = this.quotesUSCachingServer4RbpService.execute(quoteServiceRequest);
    ...
    public void testValidateServiceResponse() throws Exception {
        Object quoteServiceRequest = this.quotesUSCachingServer4RbpService.convertRequest(secQuotesRequest, commonRequestHeader);
        Object serviceResponseMapper = this.quotesUSCachingServer4RbpService.execute(quoteServiceRequest);
        assertNotNull(quotesUSCachingServer4RbpService.validateServiceResponse(serviceResponseMapper));
    }

    @Test
    public void testConvertLabciResponse() throws Exception{
        List<String> list = new ArrayList<>();
        list.add("symbol");
        list.add("bidPrice");
        list.add("askPrice");
        list.add("currency");
        list.add("nominalPrice");
        list.add("tradeDate");
        list.add("tradeTime");
        list.add("recStatus");

        Map<String, Map<String, String[]>> fieldMappers = new HashMap<>();

        Map<String, String[]> labciFieldMap = new HashMap<>();
        fieldMappers.put("HK_HASE|SEC|NYSE Arca", labciFieldMap);
        fieldMappers.put("HK_HASE|SEC|HKG", labciFieldMap);
        labciFieldMap.put("askPrice", new String[]{"ASK"});
        labciFieldMap.put("bidPrice", new String[]{"BID"});
        labciFieldMap.put("currency", new String[]{"CURRENCY"});
        labciFieldMap.put("nominalPrice", new String[]{"TRDPRC_1"});
        labciFieldMap.put("asOfDate", new String[]{"TRADE_DATE"});
        labciFieldMap.put("lastExecutionTime", new String[]{"SALTIM_MS"});

        Object quoteServiceRequest = this.quotesUSCachingServer4RbpService.convertRequest(secQuotesRequest, commonRequestHeader);
        Object serviceResponseMapper = this.quotesUSCachingServer4RbpService.execute(quoteServiceRequest);
        ArgsHolder.putArgs("RBP_REQUEST_FIELDS", list);
        ArgsHolder.putArgs(Constant.THREAD_INVISIBLE_RESPONSE_LABCI_FIELD_MAPPER, fieldMappers);

        List<QuotesLabciQuoteByRequestFields> quotesLabciQuoteByRequestFields = quotesUSCachingServer4RbpService.convertLabciResponse(quotesUSCachingServer4RbpService.validateServiceResponse(serviceResponseMapper));
        assertNotNull(quotesLabciQuoteByRequestFields);
    }
}
