...
public class ListedIPOServiceTest {

    @InjectMocks
    private ListedIPOService listedIPOService;
    ...
    public void testConvertRequest() throws Exception{
        List<NameValuePair> params = (List<NameValuePair>)listedIPOService.convertRequest(request,commonRequestHeader);
    ...
    public void testLocalConvertRequest() throws Exception{
        ...
        assertNotNull(listedIPOService.convertRequest(request,commonRequestHeader));
    }
    ...
    public void testExecute() throws Exception{
        List<NameValuePair> params = (List<NameValuePair>)listedIPOService.convertRequest(request,commonRequestHeader);
        assertNotNull(listedIPOService.execute(params));
    }
    ...
    public void testValidateServiceResponse() throws Exception{
        ...
        when(httpClientHelper.doGet(any(String.class),any(String.class),any(ArrayList.class),any(HashMap.class))).thenReturn(httpResult);
        List<NameValuePair> params = (List<NameValuePair>)listedIPOService.convertRequest(request,commonRequestHeader);
        String response = (String) listedIPOService.execute(params);
        assertNotNull(listedIPOService.validateServiceResponse(response));
    }
    ...
    public void testConvertResponse() throws Exception{
        ...
        List<NameValuePair> params = (List<NameValuePair>)listedIPOService.convertRequest(request,commonRequestHeader);
        String response = (String) listedIPOService.execute(params);
        assertNotNull(listedIPOService.convertResponse(listedIPOService.validateServiceResponse(response)));
    }
}
