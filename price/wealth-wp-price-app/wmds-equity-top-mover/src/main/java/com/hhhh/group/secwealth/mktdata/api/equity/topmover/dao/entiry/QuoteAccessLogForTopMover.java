...
@Setter
@Entity
@Table(name = "MKT_DATA_CHNL_ACCES_LOG")
public class QuoteAccessLogForTopMover implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sequenceGenerator")
	@SequenceGenerator(name = "sequenceGenerator", sequenceName = "MKT_DATA_CHNL_ACCES_LOG_SEQ", allocationSize = 1)
