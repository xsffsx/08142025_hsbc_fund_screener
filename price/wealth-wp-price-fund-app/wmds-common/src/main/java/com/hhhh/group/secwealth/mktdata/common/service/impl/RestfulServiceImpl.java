...
public class RestfulServiceImpl implements RestfulService {
    ...
    @PostConstruct
    public void init() {
        LogUtil.info(RestfulController.class, "set to https TLSv1,TLSv1.1,TLSv1.2");
    ...
    private Map<String, String> getHeaderMapAndValidate(final HttpServletRequest request) {
        ...
        while (headerNames.hasMoreElements()) {
            ...
            LogUtil.debug(RestfulController.class, "All the Request headers " + CommonConstants.INBOUND_MSG_PREFIX
                + " Request headers key: " + key + "Request headers value: " + request.getHeader(key));
    ...
    private void validChannelIdAndAppCode(final String site, final Map<String, String> headerMap) {
        ...
        if (StringUtil.isValid(appCode) && !CommonConstants.ALL.equals(appCode)) {
            ...
            if (appCodeReq != null && !ArrayUtils.contains(appCodeArray, appCodeReq)) {
    ...
    private ResponseEntity<?> doService(final String siteKey, final String serviceId, final Map<String, String> headerMap,
        ...
        Object obj = service.doService(req);
