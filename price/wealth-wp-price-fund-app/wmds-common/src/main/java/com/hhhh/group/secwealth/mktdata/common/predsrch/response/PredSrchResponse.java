package com.hhhh.group.secwealth.mktdata.common.predsrch.response;
...
public class PredSrchResponse {
    ...
    public String toString() {
        ...
        builder.append(", gbaAcctTrdb=");
        builder.append(this.gbaAcctTrdb);
        builder.append(", gnrAcctTrdb=");
        builder.append(this.gnrAcctTrdb);
        builder.append("]");
