...
public class SiteFeature {
    ...
    private final String DEFAULT_SITE = "DEFAULT";
    private final String FILE_PATH = "system/appConfig.properties";
    private PropertyUtil prop;

    @PostConstruct
    public void init() throws Exception {
        this.prop = new PropertyUtil(this.FILE_PATH);
    }
    ...
    public String getStringDefaultFeature(final String site, final String key) {
        ...
        if (StringUtil.isInvalid(value)) {
            value = this.getStringFeature(this.DEFAULT_SITE + key);
        }
        return value;
    }
}
