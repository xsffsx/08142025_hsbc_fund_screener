...
class HoldingAllocationDaoImplTest {

    @InjectMocks
    private HoldingAllocationDaoImpl underTest;
    ...
    void searchHoldingAllocation() throws Exception{
        ...
        request.setProdCdeAltClassCde("M");
        request.setProductType("UT");
        Assert.assertNotNull(underTest.searchHoldingAllocation("OF843434"));
