...
class FundCompareDaoImplTest {
    @InjectMocks
    private FundCompareDaoImpl underTest;
    ...
    @Test
    void searchForCompare() throws Exception {
        ...
        Assert.assertNull(underTest.searchForCompare(request));
    }
}