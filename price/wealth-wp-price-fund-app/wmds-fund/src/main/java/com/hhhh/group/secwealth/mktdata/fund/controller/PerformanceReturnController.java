...
public class PerformanceReturnController {
    private final String METHOD = "PERFORMANCERETURN";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/detail/performance/return", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(PerformanceReturnController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(PerformanceReturnController.class,
                "CommonException: PerformanceReturnController, get method, JSONObject.fromObject error json: " + json, e);
