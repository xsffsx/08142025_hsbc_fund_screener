...
public class RedemptionFeesController {

    private final String METHOD = "REDEMPTIONFEES";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/fees", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(RedemptionFeesController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(RedemptionFeesController.class,
                "CommonException: RedemptionFeesController, get method, JSONObject.fromObject error json: " + json, e);
