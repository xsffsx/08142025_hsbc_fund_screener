...
public class QuotePerformanceController {

    private final String METHOD = "QUOTEPERFORMANCE";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/detail/performance", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(QuotePerformanceController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(QuotePerformanceController.class,
                "CommonException: QuotePerformanceController, get method, JSONObject.fromObject error json: " + json, e);
