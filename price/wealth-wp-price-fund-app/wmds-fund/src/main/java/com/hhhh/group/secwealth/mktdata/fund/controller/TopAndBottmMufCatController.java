...
public class TopAndBottmMufCatController {

    private final String METHOD = "FUNDTOPANDBOTTOMCATEGORY";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/category", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(TopAndBottmMufCatController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(TopAndBottmMufCatController.class,
                "CommonException: TopAndBottmMufCatController, get method, JSONObject.fromObject error json: " + json, e);
