...
public class FundQuoteSummaryController {

    private final String METHOD = "FUNDQUOTESUMMARY";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/detail/summary", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(FundQuoteSummaryController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(FundQuoteSummaryController.class,
                "CommonException: FundQuoteSummaryController, get method, JSONObject.fromObject error json: " + json, e);
