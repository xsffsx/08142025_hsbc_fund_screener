...
public class HoldingAllocationController {

    private final String METHOD = "HOLDINGALLOCATION";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/holding/groups", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(HoldingAllocationController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(HoldingAllocationController.class,
                "CommonException: HoldingAllocationController, get method, JSONObject.fromObject error json: " + json, e);
