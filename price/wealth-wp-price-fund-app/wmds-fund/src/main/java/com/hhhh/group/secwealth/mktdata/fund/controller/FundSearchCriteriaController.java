...
public class FundSearchCriteriaController {

    private final String METHOD = "FUNDSEARCHCRITERIA";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/search/reference-data", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(FundSearchCriteriaController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(FundSearchCriteriaController.class,
                "CommonException: FundSearchCriteriaController, get method, JSONObject.fromObject error json: " + json, e);
