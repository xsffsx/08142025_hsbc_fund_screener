...
public class CategoryOverviewController {
    ...
    private final String METHOD = "CATEGORYOVERVIEW";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/performance/category", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(CategoryOverviewController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(CategoryOverviewController.class,
                "CommonException: CategoryOverviewController, get method, JSONObject.fromObject error json: " + json, e);
