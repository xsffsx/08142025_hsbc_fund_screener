...
public class FundCompareIndexController {
    private final String METHOD = "FUNDCOMPAREINDEX";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/search/index", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(FundCompareIndexController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(FundCompareIndexController.class,
                "CommonException: FundCompareIndexController, get method, JSONObject.fromObject error json: " + json, e);
