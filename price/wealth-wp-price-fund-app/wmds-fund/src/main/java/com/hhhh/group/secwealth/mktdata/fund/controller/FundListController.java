...
public class FundListController {
    private final String METHOD = "FUNDLIST";
    ...
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        ...
        LogUtil.infoInboundMsg(FundListController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(FundListController.class,
                "CommonException: FundListController, get method, JSONObject.fromObject error json: " + json, e);
