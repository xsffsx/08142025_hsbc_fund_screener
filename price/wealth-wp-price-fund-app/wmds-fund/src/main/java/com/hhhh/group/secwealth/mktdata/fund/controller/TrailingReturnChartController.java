...
public class TrailingReturnChartController {

    private final String METHOD = "TRAILINGRETURNCHART";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/charts/trailing-returns", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(TrailingReturnChartController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(TrailingReturnChartController.class,
                "CommonException: TrailingReturnChartController, get method, JSONObject.fromObject error json: " + json, e);
