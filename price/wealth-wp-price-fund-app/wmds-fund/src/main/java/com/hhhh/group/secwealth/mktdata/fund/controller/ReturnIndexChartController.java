...
public class ReturnIndexChartController {

    private final String METHOD = "RETURNINDEXCHART";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/charts/index", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(ReturnIndexChartController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(ReturnIndexChartController.class,
                "CommonException: ReturnIndexChartController, get method, JSONObject.fromObject error json: " + json, e);
