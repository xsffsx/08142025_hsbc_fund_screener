...
public class TopAndBottmCatChartController {

    private final String METHOD = "FUNDTOPANDBOTTOMCATEGORYCHART";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/charts/category", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(TopAndBottmCatChartController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(TopAndBottmCatChartController.class,
                "CommonException: TopAndBottmCatChartController, get method, JSONObject.fromObject error json: " + json, e);
