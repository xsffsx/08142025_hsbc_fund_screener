...
public class AdvanceChartController {

    private final String METHOD = "ADVANCECHART";
    ...
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        ...
        LogUtil.infoInboundMsg(AdvanceChartController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(AdvanceChartController.class,
                "CommonException: AdvanceChartController, get method, JSONObject.fromObject error json: " + json, e);
