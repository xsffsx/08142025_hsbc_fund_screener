...
public class FundHoldingsDiversifiController {

    private final String METHOD = "FUNDHOLDINGSDIVERSIFICATION";
    ...
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        ...
        LogUtil.infoInboundMsg(FundHoldingsDiversifiController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(FundHoldingsDiversifiController.class,
                "CommonException: FundHoldingsDiversifiController, get method, JSONObject.fromObject error json: " + json, e);
