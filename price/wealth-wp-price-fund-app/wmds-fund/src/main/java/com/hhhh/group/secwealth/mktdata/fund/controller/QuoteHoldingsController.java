...
public class QuoteHoldingsController {

    private final String METHOD = "QUOTEHOLDINGS";

    @Autowired
    @Qualifier("restfulService")
    private RestfulService restfulService;

    @RequestMapping(value = "/fund/analysis/fundamental", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(QuoteHoldingsController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(QuoteHoldingsController.class,
                "CommonException: QuoteHoldingsController, get method, JSONObject.fromObject error json: " + json, e);
