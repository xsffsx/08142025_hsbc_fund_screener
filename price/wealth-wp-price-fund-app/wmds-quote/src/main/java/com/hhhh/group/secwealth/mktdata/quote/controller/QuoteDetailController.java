...
public class QuoteDetailController {
    ...
    private final String METHOD = "QUOTEDETAIL";

    // @Autowired
    // @Qualifier("restfulService")
    private RestfulService restfulService;

    // @RequestMapping(value = "/fund/detail", method = RequestMethod.GET)
    public ResponseEntity<?> get(@RequestParam(name = "param", required = true) final String param,
        final HttpServletRequest request) throws Exception {
        LogUtil.infoInboundMsg(QuoteDetailController.class, "RequestMethod: GET",
        ...
        try {
            ...
            LogUtil.error(QuoteDetailController.class,
                "CommonException: QuoteDetailController, get method, JSONObject.fromObject error json: " + json, e);
