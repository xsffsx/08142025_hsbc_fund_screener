 ...
 * @apiSuccess {Date} products.summary.exchangeUpdatedTime Last updated time for the specified symbol.format: yyyy-MM-dd
 ...
 * @apiSuccess {String} products.summary.actualManagementFee Actual Management Fee.
 * @apiSuccess {String} products.summary.annualReportOngoingCharge AnnualReportOngoing Charge.
