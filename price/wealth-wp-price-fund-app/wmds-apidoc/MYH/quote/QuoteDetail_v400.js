/**
 * @api {get} /v4.0/market-data/fund/detail/summary Quote Detail
 ...
 * @apiSuccess {String} priceQuote.islamProInd islamic product indicator.
 * @apiSuccess {String} priceQuote.epfAppointedFunds EPF Appointed Fund.
 * @apiSuccess {String} priceQuote.restrInvstrProdInd Restricted invester product indicator.
 ...
 * @apiSuccess {String} priceQuote.distributionFrequency Interval at which reqular dividends are distributed.
 ...
 * @apiSuccess {String} priceQuotes.allowBuy allowBuy indicator.
 * @apiSuccess {String} priceQuotes.allowSell allowSell indicator.
 * @apiSuccess {String} priceQuotes.piFundInd Private Fund(PI Fund) indicator.
 * @apiSuccess {String} priceQuotes.deAuthFundInd De-Authorized Fund indicator.
