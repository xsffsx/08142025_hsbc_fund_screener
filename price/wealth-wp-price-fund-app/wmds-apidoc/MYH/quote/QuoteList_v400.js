/**
 * @api {get} /v4.0/market-data/fund/list/summary Quote List
 * @apiName Quote List
 * @apiGroup Quote
 * @apiVersion 4.0.0
 * 
 ...
 * @apiSuccess {String} priceQuotes.islamProInd islamic product indicator.
 * @apiSuccess {String} priceQuotes.epfAppointedFunds EPF Appointed Fund.
 * @apiSuccess {String} priceQuotes.restrInvstrProdInd Restricted invester product indicator.
