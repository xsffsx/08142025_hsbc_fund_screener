/**
 * @api {post} /v4.0/market-data/fund/search/result Fund Search Result
 ...
 * @apiSuccess {String} products.header.islamProInd islamic product indicator.
 * @apiSuccess {String} products.header.epfAppointedFunds EPF Appointed Fund.
 * @apiSuccess {String} products.header.restrInvstrProdInd Restricted invester product indicator.
