 ...
 * @apiSuccess {String} products.header.siFundCatCde Flex invest Fund Category code.
 ...
 * @apiSuccess {String} products.profile.inDealDate Indicative order deal date (in yyyy-MM-dd format) if an order is placed today.
 * @apiSuccess {String} products.profile.inScribStlDate Indicative order settlement date (in yyyy-MM-dd format) if an subscription order is placed today.
 * @apiSuccess {String} products.profile.inRedempStlDate Indicative order settlement date (in yyyy-MM-dd format) if an redemption order is placed today.
 * @apiSuccess {String} products.profile.gbaAcctTrdb gba account tradeble.
 * @apiSuccess {String} products.profile.gnrAcctTrdb  general accont tradeble.
 * @apiSuccess {Number} products.profile.shortListRPQLvlNum  short list RPQ level num.
 ...
 *					"undlIndexCde": null ,
 *					"inDealDate": "16:00" ,
 *					"inScribStlDate": "2020-04-10" ,
 *					"inRedempStlDate": "2020-04-10",
 *					"gbaAcctTrdb": "Y",
 *					"gnrAcctTrdb": "",
 *					"shortListRPQLvlNum":3
 *				},
 *				"rating": {
 *					"morningstarRating": "5",
