 ...
 * @apiParam {String} productKeys.prodCdeAltClassCde support M,  Denotes the alternative classification of the product. It indicates whether this alternative product code is belong to International Securities Identification Number (ISIN) or Eurclear Common Code.
 ...
 * @apiSuccess {String} result.productName The name of fund
 * @apiSuccess {String} result.indexName The name of underlying index name
 * @apiSuccess {String} result.currency The currency.
