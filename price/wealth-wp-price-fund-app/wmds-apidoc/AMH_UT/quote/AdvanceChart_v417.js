 ...
 * @apiParam {String} productKeys.prodCdeAltClassCde support M|Z, when value is Z,then prodAltNum is indexID value,  Denotes the alternative classification of the product. It indicates whether this alternative product code is belong to International Securities Identification Number (ISIN) or Eurclear Common Code.
 ...
 * 										 navPrice - NAV Price</br>
 *                                       indexReturn - performance growth </br>
 *                                       indexPrice - NAV price</br>
 *                                       note: when prodCdeAltClassCde is M then dataType:["cumulativeReturn","navPrice"],else prodCdeAltClassCde is Z then dataType["indexReturn","indexPrice"]
 * @apiParam {String} Frequency Frequency values as below:</br>
 * 										 daily - Daily data</br>
 * 										 monthly - Monthly data
 * @apiParam {Boolean} [navForwardFill] If backfill non-pricing nav Price, default is false.
 * 
 ...
 * 			"market": "HK",
 * 			"productType": "UT",
 * 			"prodCdeAltClassCde": "Z",
 * 			"prodAltNum": "F00000NERK"
 * 			}],
 ...
 * 		"period": "YTD",
 * 		"currency":"EUR",
 * 		"dataType": ["indexReturn", "indexPrice"],
 * 		"frequency": "daily",
 * 		"navForwardFill": true,
 * 	}
 *
 ...
 * @apiSuccess {String} result.Frequency Frequency values as below:</br>
 * 										 daily - Daily data</br>
 * 										 monthly - Monthly data
 *  
 *  
 ...
 *{
 *	"result": [{
 *		"productName": "Fidelity Funds - Nordic Fund (Class A-ADIST Unit)",
 *		"currency": "EUR",
 *		"frequency": "daily",
 *		"prodAltNumSegs": null
 *		"data": [{
