 ...
 * @apiSuccess {Number} summary.assetsUnderManagement Fund size.
 * @apiSuccess {String} summary.distributionFee Distribution fee.
 * @apiSuccess {String} summary.maintenanceFee Maintenance fee.
 * @apiSuccess {String} summary.redemptionFee Redemption fee.
 * @apiSuccess {String} summary.performanceFee Performance fee.
 * @apiSuccess {String} summary.disclaimer Disclaimer.
 * @apiSuccess {Number} summary.return1Yr Annualised return.
 * @apiSuccess {Number} summary.return3Yr % Return (Fund - 3 Year).
 * @apiSuccess {Number} summary.return5Yr % Return (Fund - 5 Year).
 * @apiSuccess {Number} summary.return10Yr % Return (Fund - 10 Year).
 ...
 * @apiSuccess {String} summary.investmentStrategy.investmentStyle Investment style.
 * @apiSuccess {String} summary.investmentStrategy.interestRateSensitivity Interest rate sensitivity.
 * @apiSuccess {String} summary.investmentStrategy.investmentInstrument Investment instrument.
 * @apiSuccess {Object} summary.yieldAndCredit
 * @apiSuccess {String} summary.yieldAndCredit.averageCurrencyYield Average currency yield.
 * @apiSuccess {String} summary.yieldAndCredit.averageYieldToMaturity Average yield to maturity.
 * @apiSuccess {String} summary.yieldAndCredit.averageDuration Average duration.
 * @apiSuccess {String} summary.yieldAndCredit.creditQualityBreakdown Credit quality breakdown.
 * @apiSuccess {String} summary.rating
 ...
 *				},
 *				"yieldAndCredit": {
 *					"averageCurrencyYield": null,
 *					"averageYieldToMaturity": null,
 *					"averageDuration": null,
 *					"creditQualityBreakdown": null
 *				},
 *				"rating": {
 *					"rank1Yr": null,
 *					"rank3Yr": null,
